...
<div class="edit-track-form">
    <div>
        <form action="/musicwebapp/controller?command=addToPlaylist&id=${track.id}" method="post">
            <div>
                <select class="select-artist" name="playlistId">
                    <option selected disabled>selectPlaylist</option>
