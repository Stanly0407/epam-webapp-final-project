                    ...
                    <div class="edit-delete-link">
                        <c:if test="${comment.currentUserAuthor }">
                            <p>
                                ...
                                | <a class="comment-link" href="<c:url value='controller?command=deleteComment&id=${comment.id}'/>">${delete}</a>
                            </p></c:if>
                        <c:if test="${sessionScope.role eq 'ADMIN'}">
                            <a class="comment-link" style="color: red" href="<c:url value='controller?command=deleteUserComment&id=${comment.id}'/>">${delete}</a>
                        </c:if>
                    </div>
                </div>
            </c:forEach>
