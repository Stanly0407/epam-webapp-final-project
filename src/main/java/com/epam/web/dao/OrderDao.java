...
public class OrderDao extends AbstractDao<Order> implements Dao<Order> {
    ...
    private static final String GET_USER_ORDER_STATUS = "SELECT pod.id, pod.order_date, pod.is_paid, pod.user_id " +
            "FROM purchase_order pod " +
    ...
    public List<Order> getAllUserOrders(Long userId) throws DaoException {
        return executeQuery(FIND_ORDERS_BY_USER_ID, userId);
    }
