...
public class ShowUserTrackListCommand implements Command {
    ...
    public ShowUserTrackListCommand(TrackService trackService, MusicCollectionService musicCollectionService) {
